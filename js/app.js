...
const VEHICULOS = [
    ...
    { id: 2, marca: "Toyota", modelo: "Yaris", tipo: "Sedán", anio: 2023, precio: 28000, disponible: false, transmision: "Manual", pasajeros: 5, rendimiento: "17 km/l", imagen: "img/autos/toyota_yaris.jpg", descripcion: "Económico y práctico. Un sedán compacto perfecto para el día a día y fácil de estacionar." },
    ...
    // --- VOLKSWAGEN (4) ---
    { id: 5, marca: "Volkswagen", modelo: "Golf", tipo: "Hatchback", anio: 2023, precio: 32000, disponible: false, transmision: "Manual", pasajeros: 5, rendimiento: "16 km/l", imagen: "img/autos/vw_golf.jpg", descripcion: "Un clásico moderno. Hatchback de manejo deportivo, interior refinado y excelente estabilidad." },
    { id: 6, marca: "Volkswagen", modelo: "Polo", tipo: "Hatchback", anio: 2024, precio: 27000, disponible: false, transmision: "Manual", pasajeros: 5, rendimiento: "18 km/l", imagen: "img/autos/vw_polo.jpg", descripcion: "Ágil y eficiente. Hatchback urbano con tecnología alemana, ideal para moverte por la ciudad." },
    ...
    // --- MAZDA (4) ---
    { id: 9, marca: "Mazda", modelo: "Mazda 3 Sedán", tipo: "Sedán", anio: 2024, precio: 38000, disponible: true, transmision: "Automática", pasajeros: 5, rendimiento: "14.5 km/l", imagen: "img/autos/mazda3sedan.jpg", descripcion: "Diseño elegante y manejo dinámico. Interior premium y tecnología que te conecta con el camino." },
    { id: 10, marca: "Mazda", modelo: "Mazda 3 Sport", tipo: "Hatchback", anio: 2024, precio: 39000, disponible: true, transmision: "Manual", pasajeros: 5, rendimiento: "14.2 km/l", imagen: "img/autos/mazda3sport.jpg", descripcion: "Hatchback deportivo y audaz. Líneas fluidas y una experiencia de conducción emocionante." },
    { id: 11, marca: "Mazda", modelo: "Mazda 2 Sedán", tipo: "Sedán", anio: 2023, precio: 26000, disponible: true, transmision: "Manual", pasajeros: 5, rendimiento: "16.8 km/l", imagen: "img/autos/mazda2sedan.jpg", descripcion: "Eficiencia con estilo. Un sedán subcompacto ágil, económico y con acabados de alta calidad." },
    { id: 12, marca: "Mazda", modelo: "Mazda 2 Sport", tipo: "Hatchback", anio: 2023, precio: 27000, disponible: true, transmision: "Automática", pasajeros: 5, rendimiento: "16.3 km/l", imagen: "img/autos/mazda2sport.jpg", descripcion: "Divertido y compacto. Hatchback ideal para la ciudad con gran respuesta y diseño cautivador." }
];
